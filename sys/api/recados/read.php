...
$getRecados = mysqli_query($__CONEXAO__, "select * from recados where time>'$__TIME__' and type='1' and toid='$__ID__' or time>'$__TIME__' and type='2' and toid in (select id from turmas where id in (select turma from alunos where email='$__EMAIL__')) or time>'$__TIME__' and type='3' and toid='0'");
